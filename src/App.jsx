...
export default function App(){
  ...
  var dk=theme==="dark";
  var T={bg:dk?"#0a0d14":"#f0f2f5",bg2:dk?"#141820":"#ffffff",bg3:dk?"#0d1017":"#f8f9fa",border:dk?"#1e2330":"#e2e5ea",border2:dk?"#2a2f3a":"#d0d5dd",text:dk?"#e2e8f0":"#1a1a2e",text2:dk?"#94a3b8":"#64748b",text3:dk?"#64748b":"#94a3b8",navy:"#394265",navyLight:"#4a5580",white:"#ffffff"};
  ...
  if(sec==="home") return(
    <div style={{minHeight:"100vh",background:T.bg,color:T.text,fontFamily:"'DM Sans',sans-serif",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:20}}>
      ...
      <h1 style={{margin:0,fontSize:26,fontWeight:900,color:T.text}}>T2Tcrm</h1>
      <p style={{color:T.text3,fontSize:13,marginBottom:40}}>Gestión integral del centro</p>
      <div style={{display:"flex",gap:20,flexWrap:"wrap",justifyContent:"center",maxWidth:900}}>
        <button onClick={function(){setSec("entrenamiento");setMv("clientes");}} style={{width:260,padding:"40px 30px",background:dk?"linear-gradient(135deg,#1a2040,#141820)":T.bg2,border:"2px solid "+T.navy+"30",borderRadius:20,cursor:"pointer",textAlign:"center",boxShadow:dk?"none":"0 4px 16px rgba(0,0,0,.08)"}}>
          <div style={{fontSize:48,marginBottom:12}}>🏋️</div>
          <div style={{fontSize:20,fontWeight:800,color:T.text,marginBottom:6}}>Entrenamiento</div>
          <div style={{fontSize:12,color:T.text3}}>Clientes, fichas, seguimiento y leads</div>
        ...
        <button onClick={function(){setSec("nutricion");}} style={{width:260,padding:"40px 30px",background:dk?"linear-gradient(135deg,#0a1a10,#141820)":T.bg2,border:"2px solid #22c55e20",borderRadius:20,cursor:"pointer",textAlign:"center",boxShadow:dk?"none":"0 4px 16px rgba(0,0,0,.08)"}}>
          <div style={{fontSize:48,marginBottom:12}}>🥗</div>
          <div style={{fontSize:20,fontWeight:800,color:T.text,marginBottom:6}}>Nutrición</div>
          <div style={{fontSize:12,color:T.text3}}>Próximamente</div>
        </button>
        <button onClick={function(){setSec("fisio");}} style={{width:260,padding:"40px 30px",background:dk?"linear-gradient(135deg,#1a0a2a,#141820)":T.bg2,border:"2px solid #a78bfa20",borderRadius:20,cursor:"pointer",textAlign:"center",boxShadow:dk?"none":"0 4px 16px rgba(0,0,0,.08)"}}>
          <div style={{fontSize:48,marginBottom:12}}>🩺</div>
          <div style={{fontSize:20,fontWeight:800,color:T.text,marginBottom:6}}>Fisioterapia</div>
  ...
  if(sec==="nutricion") return(
    <div style={{minHeight:"100vh",background:"#0a0d14",color:T.text,fontFamily:"'DM Sans',sans-serif"}}>
      <div style={{background:"linear-gradient(135deg,#0a1a10,#0a0d14)",borderBottom:"1px solid #1e2330",padding:"16px 20px"}}>
        <div style={{maxWidth:1100,margin:"0 auto",display:"flex",alignItems:"center",gap:12}}>
          <button onClick={function(){setSec("home");}} style={{padding:"6px 14px",background:"#1e2330",border:"1px solid "+T.border2,borderRadius:8,color:T.text2,fontSize:12,fontWeight:600,cursor:"pointer"}}>← Inicio</button>
  ...
  <div style={{background:dk?"linear-gradient(135deg,#1a2040,#0a0d14)":"#394265",borderBottom:"1px solid "+T.border,position:"sticky",top:0,zIndex:50}}>
  ...
  <div style={{display:"flex",gap:4,padding:"6px 0"}}>{[["clientes","📊","Fichas"],["panel","👥","Clientes"],["seguimiento","📋","Seguimiento"],["leads","🎯","Leads"],["horarios","📅","Horarios"]].map(function(x){var active=mv===x[0];return<button key={x[0]} onClick={function(){setMv(x[0]);}} style={{padding:"12px 20px",border:"none",borderBottom:active?"3px solid "+(dk?"#8ba3d9":"#fff"):"3px solid transparent",background:active?(dk?"rgba(99,102,241,.1)":"rgba(255,255,255,.15)"):"transparent",color:active?(dk?"#e2e8f0":"#fff"):(dk?"#64748b":"rgba(255,255,255,.5)"),fontSize:14,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:8,borderRadius:"8px 8px 0 0"}}><span style={{fontSize:18}}>{x[1]}</span>{x[2]}{x[0]==="seguimiento"&&pc>0?<span style={{fontSize:9,padding:"2px 6px",borderRadius:8,background:"#ef4444",color:"#fff",fontWeight:800}}>{pc}</span>:null}</button>;})}</div>
  </div></div>
